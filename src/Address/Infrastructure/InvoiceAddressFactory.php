    ...
    public function createValidInvoiceAddressType(
        ...
        $customer->assign(
            [
                ...
                'oxfname'     => $firstName,
                'oxlname'     => $lastName,
                'oxcompany'   => $company ? $company : $customer->getFieldData('oxcompany'),
                'oxaddinfo'   => $additionalInfo ? $additionalInfo : $customer->getFieldData('oxaddinfo'),
                'oxstreet'    => $street,
                ...
                'oxustid'     => $vatID ? $vatID : $customer->getFieldData('oxustid'),
                'oxprivphone' => $phone ? $phone : $customer->getFieldData('oxprivphone'),
                'oxmobfone'   => $mobile ? $mobile : $customer->getFieldData('oxmobfone'),
                'oxfax'       => $fax ? $fax : $customer->getFieldData('oxfax'),
            ]
        );
